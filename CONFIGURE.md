...
- English: `index.html`, `about.html`, `research.html`, `projects.html`, `contact.html`
- Traditional Chinese: the matching files inside `zh-tw/`

Every English page has a direct language link to its Traditional Chinese counterpart.
